...
public class DemoActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            PackageInfo info = getPackageManager().getPackageInfo("com.deange.githubstatus", PackageManager.GET_SIGNATURES);
    ...
    private void sendRegistrationIdToBackend() {
        ...
        try {
            ...
            Log.v(TAG, Arrays.toString(response.getAllHeaders()) + ", CODE = " + response.getStatusLine().getStatusCode());
